 ...
 * @author Dusan
 */
public class ObicnoDryKipKrojna extends javax.swing.JFrame {
...
//        ***********************STOK*****************************************
        ...
        Util.snimiStok(pozicija, "radno + dry-kip", listaStoka);
...
//        ***********************T PRECKA*****************************************
        ...
        Util.snimiTPrecku(pozicija, "radno + dry-kip", listatPrecke);
        ...
        Util.snimiKrilo(pozicija, "radno + dry-kip", listaKrila);
...
//        ***********************LAJSNA*****************************************
        ...
        Util.snimiLajsna(pozicija, "radno + dry-kip", listaLajsna);
...
//        ***********************OJACANJE*****************************************
        ...
        Util.snimiOjacanje(pozicija, "radno + dry-kip", listaOjacanje);        
...
//        ***********************STAKLO*****************************************
        ...
        Util.snimiStaklo(pozicija, "radno + dry-kip", listaStaklo);
              
    }
    public ObicnoDryKipKrojna() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stolarija/slike/slikeZaKrojnu/jednokrilni + kip novo380.png"))); // NOI18N
        ...
        jLabel2.setText("pomocno + dry-kip");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("sirina jednokrilnog :");
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addGap(75, 75, 75)
                                        .addComponent(pozicijaText, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void postaviListuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_postaviListuActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ObicnoDryKipKrojna.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObicnoDryKipKrojna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ObicnoDryKipKrojna().setVisible(true);
            }
        });
    }
